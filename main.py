...
def receive_speech_file():
    ...
    audio_file_path_A = os.path.join('/static/audio', selected_file)
    return jsonify({'message': 'Received speechFile successfully'})

@app.route('/record_audio', methods=['POST'])
def record_audio():
    global audio_file_path_B
    audio_file_path_B = '/static/audio/user_input.wav'
...
# if __name__ == '__main__':
    # audio_file_path_A = '/static/audio/F.wav'
    # audio_A, sr_A = load_audio(audio_file_path_A)
    # #print(audio_A)
    # audio_file_path_B='/static/audio/A.wav'
